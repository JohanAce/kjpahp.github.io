				...
				<div class="col-xl-6 col-lg-6 col-md-6 mt-5">
                    <div class="card bg-none o-hidden border-0 my-5 text-white" style="background: none;">
                        <div class="text-justify card-body p-0">
                            <h4 style="font-weight: 800;">Sistem Pendukung Keputusan Pemilihan Penerima KJP</h4>
                            <p class="pt-4">
...
<p>
Diharapkan dengan menerapkan metode tersebut dapat mempermudah proses penyeleksian penerima KJP serta dengan adanya sistem tersebut dapat memfasilitasi dan mempermudah pengambilan keputusan pada proses penentuan penerima KJP di SMP Negeri 157 Jakarta
</p>
                        </div>
                    </div>
                </div>
