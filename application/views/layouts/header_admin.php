...
<head>
  ...
  <title>Sistem Pendukung Keputusan Pemilihan Penerima KJP</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('Login/home'); ?>">
        ...
        <div class="sidebar-brand-text mx-3">SPKPPKJP</div>
      </a>
      ...
      <!-- <li class="nav-item <?php if($page=='Atribut'){echo 'active';}?>">
        <a class="nav-link" href="<?= base_url('Atribut'); ?>">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>Atribut</span></a>
      </li> -->

      <!-- <li class="nav-item <?php if($page=='DataSiswa'){echo 'active';}?>">
      ...
      <li class="nav-item <?php if($page=='LaporanUser'){echo 'active';}?>">
        <a class="nav-link" href="<?= base_url('LaporanUser'); ?>">
          <i class="fas fa-fw fa-user"></i>
          <span>Laporan User</span></a>
      </li>

      <li class="nav-item <?php if($page=='TambahDataKeluarga'){echo 'active';}?>">
        <a class="nav-link" href="<?= base_url('TambahDataKeluarga'); ?>">
          <i class="fas fa-fw fa-user"></i>
          <span>Tambah Data Keluarga</span></a>
      </li>
	  <?php endif; ?>
    ...
    <?php if($this->session->userdata('id_user_level') == '3'): ?>      
      ...
      <li class="nav-item <?php if($page=='BobotKriteriaAHP'){echo 'active';}?>">
        <a class="nav-link" href="<?= base_url('BobotKriteriaAHP'); ?>">
          <i class="fas fa-fw fa-user"></i>
          <span>Bobot Kriteria AHP</span></a>
      </li>
    ...
    <?php if($this->session->userdata('id_user_level') == '2' || $this->session->userdata('id_user_level') == '3'): ?>
